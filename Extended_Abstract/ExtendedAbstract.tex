...
\title{Prospective studies of highly boosted Higgs pairs decaying to four b quarks}
\date{October 2018}
...
\input{ExtendedAbstract_det}

%\input{ExtendedAbstract_detFCC}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% BACKGROUND
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{ExtendedAbstract_backg}

%\input{ExtendedAbstract_sim}
