...
\begin{figure}
	...
	\caption{SUPERIMPOSE ONE BKG? MAYBE NOT}
\end{figure}
...
\begin{figure}
	...
	\label{fig:granSSB}
	\caption{$S/\sqrt{B}$ as a function of the detector configuration for $\mathcal{L}=30~\text{ab}^{-1}$ (black) and $\mathcal{L}=3~\text{ab}^{-1}$ (blue) and for particle flow jets (squares) and pure calorimeter (HCAL) jets (triangles). }
\end{figure}
...
\begin{figure}
	...
	\label{fig:granEff}
	\caption{Signal efficiency as a function of the detector configuration for particle flow jets (squares) and pure calorimeter (HCAL) jets (triangles).}
\end{figure}
