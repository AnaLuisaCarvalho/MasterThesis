...
\begin{equation}
	S/\sqrt{B}=16.7\pm 3.0~\text{(stat.)}~^{+7.8}_{-5.8}~\text{(sys.)}~\left(5.3\pm 0.9~\text{(stat.)}~^{+2.5}_{-1.8}~\text{(sys.)}\right)
\end{equation}
...
\begin{table}
	...
	\begin{tabular}{lccc}
		...
		\rowcolor{black!7}N(b-tags)$\geq4$ & $92.488$ & $92.593$ &$93.438$\\
		\multirow{2}{*}{$p_T(j_1,j_2)\geq200$ GeV} & $16.602$ & $17.033$ &$33.802$ \\ 
		& $(4490\pm5)\times 10^3$ & $(11140\pm12)\times 10^2$ & $4725\pm4\times 10^3$\\
		\midrule \midrule
		\rowcolor{black!7}$p_T(j_1)\geq 300$ GeV & $13.521$ & $14.007$ &$30.691$\\ 
		$p_T(j_1+j_2)\geq 100$ GeV & $10.933$ &$11.301$&  $22.736$ \\
		\rowcolor{black!7}$\tau_{21}(j_1,j_2)<0.4$ & $1.309$&$1.410$ &$3.921$\\
		$|\Delta \eta (hh)|<1.5$& $1.071$& $1.154$& $3.455$\\
		\rowcolor{black!7}$FW2(j_1)>0.2$ & $0.989$&$1.064$& $3.254$\\
		\multirow{2}{*}{$(100<M_{SD}(j1,j2)<135)$ GeV} & $0.446$ & $0.487$&$1.642$\\
		&$(1207\pm8)\times 10^2$&$(3188\pm20)\times10$&$(2296\pm8)\times 10^2$\\
		\bottomrule
	\end{tabular}
\end{table}
...
%	\centering
%	\includegraphics[width=0.5\textwidth]{/home/user/Transferências/FitStudyModified/neglogLikelihood_plot_var_bkg.pdf}
...
%The negative log-likelihood on the $\mu$ parameter is shown in figure \ref{fig:lumi}(a) for $\mathcal{L}=30~\text{ab}^{-1}$ (blue line) and for $\mathcal{L}=3~\text{ab}^{-1}$ (red line). The dashed line is the $1\sigma$ line that corresponds to a $68\%$ confidence level. The value found for the signal strength is $\mu = 1.0\pm 0.4 ~(1.0\pm 1.2)$ for $\mathcal{L}=30 ~(3)~\text{ab}^{-1}$. This result indicates that a precision of $\sim 40\%$ in the di-Higgs signal strength can be achieved at the FCC-hh in the $b\overline{b}b\overline{b}$ channel with an integrated luminosity of $30~\text{ab}^{-1}$. With $3~\text{ab}^{-1}$ of data, this channel does not have enough sensitivity to the di-Higgs signal strength.

%\begin{figure}
%	\centering
%	\includegraphics[trim={0 0 .55cm 0},clip,width=0.5\linewidth]{/home/user/Transferências/FitStudyModified/neglogLikelihood_plot_var_bkg.pdf}
%	\caption{oi}
%	\label{fig:lumi}
%\end{figure}
...
%This indicates that the CM energy and the high luminosity are the key factors driving the discovery potential of the accelerator.
...
\begin{table}
	...
	\begin{tabular}{lccc}
		...
		\rowcolor{black!7}N(b-tags)$\geq4$ & $88.690$ & $88.787$ & $89.624$\\
		\multirow{2}{*}{$p_T(j_1,j_2)\geq200$ GeV} & $15.533$ & $15.941$ $32.001$& \\ 
		& $(4201\pm5)\times 10^3$ & $(10426\pm12)\times 10^2$ & $(4473\pm4)\times 10^3$ \\
		\midrule \midrule
		\rowcolor{black!7}$p_T(j_1)\geq 300$ GeV & $12.599$ & $13.061$ & $28.960$\\ 
		$p_T(j_1+j_2)\geq 100$ GeV & $10.185$ &$10.526$& $21.414$  \\
		\rowcolor{black!7}$\tau_{21}(j_1,j_2)<0.4$ & $1.139$&$1.220$ & $3.394$\\
		$|\Delta\eta(hh)|<1.5$& $0.891$& $0.960$& $2.920$\\
		\rowcolor{black!7}$FW2(j_1)>0.2$ & $0.796$&$858$& $2.675$ \\
		\multirow{2}{*}{$(100<M_{SD}(j1,j2)<135)$ GeV} & $0.333$ & $0.360$& $1.245$\\
		&$(901\pm7)\times 10^2$&$(2358\pm18)\times10$& $(1741\pm8)\times 10^2$\\
		\bottomrule
	\end{tabular}
\end{table}
...
\begin{table}
	...
	\begin{tabular}{lcc}
		...
		2HDM type II & $11.1\pm 1.7 ~\text{(stat.)}~^{+5.3}_{-3.9}~\text{(sys.)}$ &  $16.7\pm 3.0~\text{(stat.)}~^{+7.8}_{-5.8}~\text{(sys.)}$\\ 
		\bottomrule
