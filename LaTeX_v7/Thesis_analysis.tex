...
\begin{figure}
	\centering
	\includegraphics[width=0.7\textwidth]{./Figures/deltaR_bsubjet}
	\caption{Minimun $\Delta R$ between b quarks and subjets of the $R=0.8$ jets. There is a minimum around $\Delta R=0.3$. It corresponds to the maximum $\Delta R$ for which the b quark and the subjet are matched.} 
...
As a first step, we implemented a baseline analysis based on the  
