...
\vspace{1.0cm}
{\FontLb Sensitivity of an hadronic future circullar collider to Higgs boson pair production in the final state with four b-quarks} \\ % <<<<< EDIT TITLE
%\vspace{0.2cm}
...
{\FontSn %
\begin{tabular}{ll}
 \coverSupervisors: & Dr. José Ricardo Gonçalo \\ % <<<<< EDIT NAME
                    & Prof. Pedro Abreu   % <<<<< EDIT NAME
\end{tabular} } \\
\vspace{1.0cm}
